...
- Весь персонал комплекса считать доверенным.
- Всех поставщиков расходных материалов (Пестициды, плодородная земля, семена) считать доверенными.
- Графический интерфейс для взаимодействия с пользователем не требуется.
