...
- Графический интерфейс для взаимодействия с оператором не требуется.
-
- добавить с гита дрона
## Цели и Предположения Безопасности (ЦПБ)
Цели безопасности:

1. Выполняются только аутентичные задания.
2. Выполняются только авторизованные системой управления комплексом задания.
3. Только авторизованные пользователи имеют доступ к производственной информации.
4. Все операции выполняются согласно заданным параметрам (температура, влажность, освещение, подача пестицидов и удобрений)

Предположения безопасности:

1. Диспетчера комлекса считать благонадежным, обладающим достаточной компетенцией.
2. Всех поставщиков расходников (семена, полодородная почва,пестициды и т.п.) считать благонадежными.
3. Добавить на схемку логистический центр
